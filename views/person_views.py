...
class PersonListView(ListView):
    model = Person
    template_name = "arosenius-admin-django/person_list.html"
    paginate_by = 20
...
class PersonDetailView(DetailView):
    model = Person
    template_name = "arosenius-admin-django/person_detail.html"
...
class PersonCreateView(CreateView):
    ...
    # fields = ['name']
    template_name = "arosenius-admin-django/person_create.html"
...
class PersonUpdateView(UpdateView):
    ...
    form_class = PersonForm
    # fields = ['name']
    template_name = "arosenius-admin-django/person_update.html"
    initial = {}
    slug_field = 'slug'
    slug_url_kwarg = 'slug'
    pk_url_kwarg = 'pk'
...
class PersonDeleteView(DeleteView):
    model = Person
    template_name = "arosenius-admin-django/person_delete.html"
    slug_field = 'slug'
    slug_url_kwarg = 'slug'
    pk_url_kwarg = 'pk'
    context_object_name = "person"
