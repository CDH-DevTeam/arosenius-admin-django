...
class PlaceListView(ListView):
    model = Place
    template_name = "arosenius-admin-django/place_list.html"
    paginate_by = 20
...
class PlaceDetailView(DetailView):
    model = Place
    template_name = "arosenius-admin-django/place_detail.html"
...
class PlaceCreateView(CreateView):
    ...
    template_name = "arosenius-admin-django/place_create.html"
...
class PlaceUpdateView(UpdateView):
    ...
    form_class = PlaceForm
    # fields = ['name', 'district', 'country', 'lat', 'lon']
    template_name = "arosenius-admin-django/place_update.html"
    initial = {}
    slug_field = 'slug'
    slug_url_kwarg = 'slug'
    pk_url_kwarg = 'pk'
...
class PlaceDeleteView(DeleteView):
    model = Place
    template_name = "arosenius-admin-django/place_delete.html"
    slug_field = 'slug'
    slug_url_kwarg = 'slug'
    pk_url_kwarg = 'pk'
    context_object_name = "place"
