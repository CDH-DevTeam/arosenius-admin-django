...
class TagListView(ListView):
    model = Tag
    template_name = "arosenius-admin-django/tag_list.html"
    paginate_by = 20
...
class TagDetailView(DetailView):
    model = Tag
    template_name = "arosenius-admin-django/tag_detail.html"
...
class TagCreateView(CreateView):
    ...
    form_class = TagForm
    # fields = ['name']
    template_name = "arosenius-admin-django/tag_create.html"
...
class TagUpdateView(UpdateView):
    ...
    form_class = TagForm
    # fields = ['name']
    template_name = "arosenius-admin-django/tag_update.html"
    initial = {}
    slug_field = 'slug'
    slug_url_kwarg = 'slug'
    pk_url_kwarg = 'pk'
...
class TagDeleteView(DeleteView):
    model = Tag
    template_name = "arosenius-admin-django/tag_delete.html"
    slug_field = 'slug'
    slug_url_kwarg = 'slug'
    pk_url_kwarg = 'pk'
    context_object_name = "tag"
